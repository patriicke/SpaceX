                ...
                <div className="w-full h-full flex items-center  justify-center gap-10 z-20 flex-col bg-opacity-40">
                    <div className="flex flex-col items-center w-full gap-8">
                        ...
                        <p className="text-white md:text-xl max-w-2xl text-center">
                            The train rocketed through the tunnel. The
                            spacecraft rocketed into outer space. Her novel
                            rocketed to the top of the best-seller list. Their
                            album rocketed up the charts.
                        </p>
                        <a
